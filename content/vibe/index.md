...
规则类策略的核心，一是在于对波动率的把握和规则的精巧设计（守正出奇），二是在于规则信号的效果立竿见影。一个评价的方法是，买入信号产生后持仓三个 bar 就卖出，如果胜率的数据依然漂亮，那这个策略就是好策略。
...
挖掘因子，主要关注两点：一个是因子的因果性（而不是相关性），另一个是因子的领先性。

## 量化和主观一样

量化和主观看待一家上市公司的视角其实一样。都是观察因子数据所表现出来的规律，理解公司质地、行业数据等基本面数据。为什么总有人认为量化就是盯着K线行情做文章呢？

## 量在价先

挖掘基本面因子和量价因子，应该更多地从量入手，注意量在价先。
...
顶背离的时候，不要着急去做空，底背离的时候，不要着急去做多。要等金叉、死叉封口再行动。背离往往是多头和空头最疯狂、最博傻的时候，尤其不要逆均线趋势去行动。
